<?php
error_reporting(0);
$conn = mysqli_connect("localhost","root","","realestatedb");
if(count($_POST)>0) {
$location=$_POST[location];
$result = mysqli_query($conn,"SELECT * FROM property where location='$location' ");
}
?>
...
<tr class="table_header" style="font-weight:bold;">
<td></td>
<td>Apartment</td>
<td>Price</td>
<td>Location</td>
...
?>
<tr>
<td><img src="property_images/<?php echo $row['image'];?>" width="300" height="200"></td>
