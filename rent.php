...
<!--banner-->
            ...
            <div class="row" id="banner_image" style="background-image:url(images/orig.jpg)">
                ...
                <div class="banner_content">
                    ...
                    <li role="presentation"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab">Buy</a></li>
                    <li role="presentation" class="active"><a href="#Section2" aria-controls="profile" role="tab" data-toggle="tab">Rent</a></li>
...
<!--Properties listing-->
		...
		<div class="col-sm-3">
		<img src="images/rent1.jpg" width="200px" height="200px">
		</div>
		<div class="col-sm-9">
        ...
        <div class="row" id="display_properties">
		<div class="col-sm-3">
		<img src="images/rent2.jpg" width="200px" height="200px">
		</div>
		<div class="col-sm-9">
		<ul class="house_properties">
		<li>Aparment:2BHK</li>
        ...
        <div class="row" id="display_properties">
		<div class="col-sm-3">
		<img src="images/rent3.jpg" width="200px" height="200px">
		</div>
		<div class="col-sm-9">
		<ul class="house_properties">
		<li>Aparment:3BHK</li>
